...
const LoginPrompt = () => {
  return (
    <div className="h-full flex flex-col items-center justify-center p-6 text-center space-y-9">
      ...
      <div className="space-y-2 max-w-[250px]">
        ...
        <p className="text-sm text-zinc-400">
          Log In to Discover what Music your Friends are Enjoying Right Now!
        </p>
      </div>
    </div>
  );
